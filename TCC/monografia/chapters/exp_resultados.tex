	...
	O gráfico e os valores do teste de \textit{throughput} para operação de leitura de arquivo são mostrados respectivamente nas Figura~\ref{fig:throughput_l} e Tabela~\ref{tab:throughput_l}.	
